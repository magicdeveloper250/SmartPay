...
export const FeatureSchema = z.object({
  id: z.string().optional(), // 'id' can be omitted if not required
  name: z.string().min(3, "Name is required"), // 'name' is required with a minimum length of 3
  description: z.string().min(3, "Description is required").optional(), // 'description' is optional, but if provided, it needs a minimum length of 3
});
