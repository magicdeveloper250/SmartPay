...
export const displayRwandaIncomeTax=({
  ...
  return ` 
  <div className="absolute z-10 bg-white p-4 border border-gray-200 rounded-lg shadow-lg top-10 left-1/2 transform -translate-x-1/2 w-80 max-w-[90vw] overflow-auto">
    <table className="w-full text-sm text-left text-gray-500">
      <thead className="text-xs text-gray-700 uppercase bg-gray-50">
        <tr>
          <th scope="col" className="px-2 py-3">Bracket</th>
          <th scope="col" className="px-2 py-3">Income Range</th>
          <th scope="col" className="px-2 py-3">Tax Rate</th>
          <th scope="col" className="px-2 py-3">Tax Amount</th>
        </tr>
      </thead>
      <tbody>
        <tr className="bg-white border-b hover:bg-gray-50">
          <td className="px-2 py-2">Lower Bracket</td>
          <td className="px-2 py-2">0 - 60,000 RWF</td>
        ...
        <tr className="bg-white border-b hover:bg-gray-50">
          <td className="px-2 py-2">Middle Bracket</td>
          <td className="px-2 py-2">60,001 - 100,000 RWF</td>
        ...
        <tr className="bg-white hover:bg-gray-50">
          <td className="px-2 py-2">Upper Bracket</td>
          <td className="px-2 py-2">100,001 RWF and above</td>
