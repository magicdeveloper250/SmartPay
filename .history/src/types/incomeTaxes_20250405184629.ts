      ...
      ">
        <thead>
          <tr style="background-color: #f9fafb;">
            <th style="padding: 0.5rem; text-align: left; border: 1px solid #d1d5db;">Bracket</th>
            <th style="padding: 0.5rem; text-align: left; border: 1px solid #d1d5db;">Income Range</th>
            <th style="padding: 0.5rem; text-align: left; border: 1px solid #d1d5db;">Tax Rate</th>
            <th style="padding: 0.5rem; text-align: left; border: 1px solid #d1d5db;">Tax Amount</th>
          </tr>
        </thead>
        <tbody>
          <tr>
