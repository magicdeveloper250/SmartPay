import type {  SupportedRwandaTaxYear,
  ...
  const rwandaTaxRates: Record<SupportedRwandaTaxYear, RwandaTaxRates> = {
    "2023": {
      ...
      LOWER_BRACKET: 60_001, // Updated to reflect the new lower bracket
      MIDDLE_BRACKET: 100_001, // Updated to reflect the new middle bracket
    ...
    "2024": {
      COUNTRY: "Rwanda",
      // Income tax
      DEFAULT_PERSONAL_ALLOWANCE: 30_000, // Updated to reflect the new tax-free threshold
