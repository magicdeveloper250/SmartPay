...
function calculateRwandaTaxes({
  ...
  console.log("nnnnnnnnnnnnnnnnn", taxableAnnualIncome - personalAllowance)
  ...
  console.log("DEFAULT_PERSONAL_ALLOWANCE:", DEFAULT_PERSONAL_ALLOWANCE);
  console.log("taxableAnnualIncome:", taxableAnnualIncome);
  console.log("Adjusted Taxable Income:", adjustedTaxableIncome);
console.log("Lower Bracket Tax:", lowerBracketTax);
console.log("Middle Bracket Tax:", middleBracketTax);
console.log("Upper Bracket Tax:", upperBracketTax);
