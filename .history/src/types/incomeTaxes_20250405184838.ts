...
export const displayRwandaIncomeTax = ({
  ...
  <div style="position: absolute; z-index: 10; background-color: white; padding: 1rem; border: 1px solid #d1d5db; border-radius: 0.5rem; box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.05); top: 2.5rem; left: 50%; transform: translateX(-50%); width: 20rem; max-width: 90vw; overflow: auto;">
    <table style="width: 100%; font-size: 0.875rem; text-align: left; color: #6b7280; border: 1px solid #d1d5db; border-collapse: collapse;">
      <thead style="font-size: 0.75rem; color: #374151; text-transform: uppercase; background-color: #f9fafb;">
        <tr>
          <th scope="col" style="padding: 0.5rem; border: 1px solid #d1d5db;">Bracket</th>
          <th scope="col" style="padding: 0.5rem; border: 1px solid #d1d5db;">Income Range</th>
          <th scope="col" style="padding: 0.5rem; border: 1px solid #d1d5db;">Tax Rate</th>
          <th scope="col" style="padding: 0.5rem; border: 1px solid #d1d5db;">Tax Amount</th>
        </tr>
      </thead>
      <tbody>
        <tr style="background-color: white; border-bottom: 1px solid #d1d5db;" onmouseover="this.style.backgroundColor='#f9fafb'" onmouseout="this.style.backgroundColor='white'">
          <td style="padding: 0.5rem; border: 1px solid #d1d5db;">Lower Bracket</td>
          <td style="padding: 0.5rem; border: 1px solid #d1d5db;">0 - 60,000 RWF</td>
          <td style="padding: 0.5rem; border: 1px solid #d1d5db;">10%</td>
        ...
        <tr style="background-color: white; border-bottom: 1px solid #d1d5db;" onmouseover="this.style.backgroundColor='#f9fafb'" onmouseout="this.style.backgroundColor='white'">
          <td style="padding: 0.5rem; border: 1px solid #d1d5db;">Middle Bracket</td>
          <td style="padding: 0.5rem; border: 1px solid #d1d5db;">60,001 - 100,000 RWF</td>
          <td style="padding: 0.5rem; border: 1px solid #d1d5db;">20%</td>
          <td style="padding: 0.5rem; border: 1px solid #d1d5db;">
            ${new Intl.NumberFormat('en-US', { style: 'currency', currency: "RWF" }).format(
              calculateRwandaIncomeTax({
                taxYear: taxYear,
        ...
        <tr style="background-color: white;" onmouseover="this.style.backgroundColor='#f9fafb'" onmouseout="this.style.backgroundColor='white'">
          <td style="padding: 0.5rem; border: 1px solid #d1d5db;">Upper Bracket</td>
          <td style="padding: 0.5rem; border: 1px solid #d1d5db;">100,001 RWF and above</td>
          <td style="padding: 0.5rem; border: 1px solid #d1d5db;">30%</td>
          <td style="padding: 0.5rem; border: 1px solid #d1d5db;">
            ${new Intl.NumberFormat('en-US', { style: 'currency', currency: "RWF" }).format(
              calculateRwandaIncomeTax({
                taxYear: taxYear,
