...
export type PayrollReturnType =
 ...
 const payrollWithEmployeeData = Prisma.validator<Prisma.PayrollDefaultArgs>()({
  ...
  type BasePayrollWithEmployeeData = Prisma.PayrollGetPayload<typeof payrollWithEmployeeData>;
  export type PayrollWithEmployeeAndCustomTaxes = Omit<BasePayrollWithEmployeeData, 'taxes'> & {
    taxes: {
      taxAmount: number;
