...
import { Plus, PencilIcon, MinusIcon,  Loader, Building2, Phone, Wallet2, CreditCard, BadgeCheck, BookHeartIcon, Trash, X, AlertCircle } from "lucide-react";
         ...
         <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
              <div className="sm:flex sm:items-start">
                <div className="mx-auto flex size-12 shrink-0 items-center justify-center rounded-full bg-red-100 sm:mx-0 sm:size-10">
                  <AlertCircle aria-hidden="true" className="size-6 text-red-600 bg-red-700" />
                </div>
