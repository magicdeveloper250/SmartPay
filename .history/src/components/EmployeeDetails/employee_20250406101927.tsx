...
import { Plus, PencilIcon, MinusIcon,  Loader, Building2, Phone, Wallet2, CreditCard, BadgeCheck, BookHeartIcon, Trash, X } from "lucide-react";
...
import { AlertWarningIcon } from '../ui-elements/alert/icons';
        ...
        <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1 gap-6">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <button className="font-medium text-white bg-red-700 w-full rounded-md hover:bg-red-500 py-2">   
         ...
         <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
              <div className="sm:flex sm:items-start">
                <div className="mx-auto flex size-12 shrink-0 items-center justify-center rounded-full bg-red-100 sm:mx-0 sm:size-10">
                  <AlertWarningIcon aria-hidden="true" className="size-6 text-red-600" />
                </div>
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                  ...
                  <div className="mt-2">
                    <p className="text-sm text-gray-500">
                      Are you sure you want to delete this employee account? All of your data will be permanently removed.
