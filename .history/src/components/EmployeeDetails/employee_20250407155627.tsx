    ...
    <div className="w-full max-w-7xl mx-auto p-4">
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="w-full lg:w-2/3">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-6 break-inside-avoid h-auto max-w-full">
            <div className="flex justify-between items-center mb-6">
              ...
              >
                     {!showBenefits ?  <Plus className="w-5 h-5" /> : isAddingBenefit ? <Loader className="w-4 h-4 animate-spin text-green-900" />:isDeletingBenefit ? <Loader className="w-4 h-4 animate-spin text-red" />: <MinusIcon className="w-5 h-5" />}
              </PrimaryButton>
            </div>
        <div className="mb-4">
          {showBenefits && (
