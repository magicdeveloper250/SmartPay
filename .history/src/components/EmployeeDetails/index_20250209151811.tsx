  ...
  return (
    <div className="w-full max-w-7xl mx-auto bg-white rounded-lg shadow-lg p-4">
        ...
        <div>
          ...
          <div>
          <div className="w-full flex justify-between gap-3 mb-3"><h2 className="text-lg font-semibold mb-4">Benefits</h2> <button><Plus className="w-5 h-5"/></button> </div>
          
          <Accordion items={employee.benefits}/>
          </div>

          <div>
          <div className="w-full flex justify-between gap-3 mb-3"><h2 className="text-lg font-semibold mb-4">Taxes</h2> <Plus className="w-5 h-5"/> </div>
          <Accordion items={employee.taxes}/>
          </div>
        </div>
