...
import { Employee, EmployeeBenefit, AppliedTax, PredefinedTax, AdditionalIncome, PaymentStatus, Deduction, PredefinedContribution} from '@prisma/client';
  ...
  return (
    ...
    <div className="w-full max-w-7xl mx-auto p-4">
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        {/* Left column - Personal Details (wider on mobile, ~30% on desktop) */}
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-6">
        ...
        { additionalIncomes.length > 0 ? (
         ...
         <li className="mb-4 p-4 bg-white rounded-lg shadow-md hover:shadow-lg transition-all duration-200 border border-gray-100"  key={index}>
            ...
            {/* Section 2 - Additional Incomes (Bottom Left) */}
            <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-6">
        <div className="flex justify-between items-center mb-6">
          <div className="flex items-center gap-3">
            <BadgeCheck className="w-5 h-5 text-blue-600" />
