...
export default function EmployeeDisplay({ employee, benefits, taxes,additionalIncomes }: { employee: Employee, benefits: EmployeeBenefit[], taxes: AppliedTax[], additionalIncomes:AdditionalIncome[], deductions:Deduction[] }) {
