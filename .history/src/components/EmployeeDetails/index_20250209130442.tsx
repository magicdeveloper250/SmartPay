...
export default async function EmployeeDetails({ employeeId }: { employeeId: string }) {
  ...
  <div className="collapse collapse-arrow join-item bg-base-100 border border-base-300 rounded-lg shadow-sm hover:shadow-md transition-shadow">
    <input type="radio" name="my-accordion-4" defaultChecked />
    <div className="collapse-title text-xl font-medium text-gray-800 flex items-center">
      <span>Click to open this one and close others</span>
    </div>
