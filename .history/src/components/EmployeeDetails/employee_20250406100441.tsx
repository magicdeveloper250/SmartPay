...
import { Plus, PencilIcon, MinusIcon,  Loader, Building2, Phone, Wallet2, CreditCard, BadgeCheck, BookHeartIcon, Trash } from "lucide-react";
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1 gap-6">
          ...
          <div className="flex items-start gap-3">
              ...
              <button className="text-md font-medium text-gray-500 bg-red-700 w-full">    <Trash className="w-5 h-5 text-red-600" /> Delete</button>
