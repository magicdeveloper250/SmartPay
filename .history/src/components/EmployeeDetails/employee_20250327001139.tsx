          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-6">
            ...
            <div className="flex justify-between items-center mb-6">
              ...
              >
                ...
                {!showTaxes ?  <Plus className="w-5 h-5" /> : isAddingTax ? <Loader className="w-4 h-4 animate-spin text-green-800" />:isDeletingTax ? <Loader className="w-4 h-4 animate-spin text-red-700" />: <MinusIcon className="w-5 h-5" />}
              </button>
            </div>
        <div className="mb-4">
          {showTaxes && (
