          ...
          <ul className="list-disc pl-5 text-gray-600">
            {benefits.map((benefit, index) => (
              <div
                ...
                key={index}
              >
                <li className="mb-2 w-full overflow-x-hidden">
                  {benefit.benefit}
                </li>
                <SecondaryButton
                  variant="danger"
        ...
        {additionalIncomes.length > 0 ? (
          <ul className="list-disc pl-5 text-gray-600">
            {additionalIncomes.map((income, index) => (
              ...
              >
                <li
                  className="mb-4 rounded-lg border border-gray-100 bg-white p-4 shadow-md transition-all duration-200 hover:shadow-lg"
                  key={index}
                >
