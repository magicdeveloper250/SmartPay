          ...
          <TableBody>
            {contractors.processedContractors.map((item, i) => (
              ...
              >
                ...
                <TableCell className="text-gray-700 flex justify-end">
                <Link href={`/contractor/internal/${item.contractor.bankName}`} scroll={false}><ChevronRight className="w-5 h-5 text-gray-400" /></Link>
