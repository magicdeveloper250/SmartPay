  ...
  <>
    {employees.map((employee, i) => (
      <TableRow key={employee.id} className="text-center text-base font-medium">
        ...
        <TableCell className="border   font-bold"></TableCell>
...
<TableRow className="text-center text-lg font-semibold bg-gray-100">
  <TableCell className="border   font-bold" colSpan={2}>Total</TableCell>
  <TableCell className="border   bg-blue-100">
  ...
  <TableCell className="border   bg-blue-100"></TableCell>
  <TableCell className="border   bg-green-100"></TableCell>
  <TableCell className="border   bg-red-100 p-0" colSpan={2}>
  ...
  <TableCell className="border   font-bold bg-blue-100">
    {new Intl.NumberFormat('en-US', { style: 'currency', currency: employees[0].currency }).format(
