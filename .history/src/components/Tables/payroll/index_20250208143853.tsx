  ...
  return (
    <div className="overflow-x-auto mt-5">
      <Table className="min-w-full border-collapse border border-gray-200">
        ...
        <TableBody>
          {tab=="employees" || tab=="" &&employees?.map((employee, i) => (
          ...
          {tab=="contractors" &&contractors?.map((contractor, i) => (
            <TableRow key={contractor.id} className="text-center text-base font-medium">
              ...
              <TableCell className="border border-gray-300 bg-blue-50">{ new Intl.NumberFormat('en-US', { style: 'currency', currency: contractor.currency }).format(contractor.contractsTerms?.salary) || "0.00"}</TableCell>
