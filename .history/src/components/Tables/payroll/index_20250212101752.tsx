             ...
             <ul>
             {
              ...
              <ul>
              {
                employee.appliedTaxes.map((tax, index)=>{
                  return <li className="border border-gray-300 bg-red-50 flex justify-between" key={index}>
                {tax.tax.name} {tax.tax.rate} {new Intl.NumberFormat('en-US', { style: 'currency', currency: employee.currency }).format(employee.monthlyGross * tax.tax.rate)}
