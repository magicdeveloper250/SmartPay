      ...
      <Table className="min-w-full border-collapse border border-gray-200">
        <TableHeader>
          ...
          <TableRow className="uppercase bg-gray-200">
            ...
            <TableHead colSpan={2} className="border border-gray-300 text-center bg-red-50">Taxes</TableHead>
             ...
             <ul className="divide-y divide-gray-200 border border-gray-200 rounded-lg">
                {employee.appliedTaxes.map((tax, index) => (
                  <li key={index} className="grid grid-cols-3 text-sm">
                    <span className="p-2 border-r border-gray-200 font-medium">
                      {tax.tax.name}
                    </span>
                    <span className="p-2 border-r border-gray-200 text-center text-gray-600">
                    ...
                    <span className="p-2 text-right font-medium">
                      ...
                      }).format(employee.monthlyGross * tax.tax.rate)}
                    </span>
                  </li>
                ))}
              </ul>
