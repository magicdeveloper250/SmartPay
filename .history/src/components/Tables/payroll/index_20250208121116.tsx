...
import { contractorSchemaType } from "@/validations/contractorSchema";
import { Contractor, Employee } from "@prisma/client";
 

export default async function Page( {records, query, currentPage}:{query:string, currentPage:number, records:EmployeeData[] | contractorSchemaType[] }) {
