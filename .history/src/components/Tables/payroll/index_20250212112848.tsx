      ...
      <Table className="min-w-full border-collapse border border-gray-200">
        <TableHeader>
          ...
          <TableHead colSpan={2} className="border border-gray-300 text-center">
            ...
            <TableHead className="border border-black-300 text-center bg-blue-100"  rowSpan={2}>
          ...
          <TableRow className="uppercase bg-gray-200">
            ...
            <TableHead colSpan={4}  className="border border-gray-300 text-center bg-red-50">Taxes</TableHead>
  ...
  <>
    {employees.map((employee, i) => (
      <TableRow key={employee.id} className="text-center text-base font-medium">
        ...
        <TableCell className="border border-black-300 text-center bg-blue-100" >0.0</TableCell>
