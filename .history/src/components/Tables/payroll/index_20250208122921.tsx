      ...
      <Table>
        <TableHeader>
          <TableRow className="border-none uppercase [&>th]:text-center">
            ...
            <TableHead className="text-center font-bold" >Employee Details</TableHead>
            <TableHead className="text-center font-bold">Earnings</TableHead>
            <TableHead className="text-center font-bold">Additions</TableHead>
            <TableHead className="text-center font-bold">Deductions</TableHead>
          </TableRow>
        </TableHeader>
