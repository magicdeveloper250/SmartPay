      ...
      <Table className="min-w-full border-collapse border border-gray-200">
        <TableHeader>
          ...
          <TableRow className="uppercase bg-gray-200">
            ...
            <TableHead className="border border-gray-300 text-center bg-blue-50">Fringe Beefit</TableHead>
        ...
        <TableBody>
          {tab=="employees" &&employees?.map((employee, i) => (
            <TableRow key={employee.id} className="text-center text-base font-medium">
              ...
              {
                employee?.benefits.map((benefit, index)=> <TableCell className="border border-gray-300 bg-blue-50" key={index}>{benefit.benefit}</TableCell>)
              }
              

              <TableCell className="border border-gray-300 bg-green-50">{"0.00"}</TableCell>
              {
