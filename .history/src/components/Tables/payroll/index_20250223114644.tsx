            ...
            <Table className="min-w-full border-collapse">
              ...
              <TableBody>
                <TableRow className="bg-gray-50/30">
                  ...
                  <TableCell className="border border-gray-200 px-6 py-4 text-lg font-bold text-green-900"></TableCell>
                  ...
                  <TableCell className="px-6 py-4 text-lg font-bold text-red-900"></TableCell>
                  <TableCell className="px-6 py-4 text-lg font-bold text-red-900" colSpan={2}>
                    <ul className="divide-y divide-gray-300 rounded-lg">
