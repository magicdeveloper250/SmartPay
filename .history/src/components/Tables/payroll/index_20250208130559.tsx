      ...
      <Table className="min-w-full border-collapse border border-gray-200">
        <TableHeader>
          <TableRow className="uppercase bg-gray-100 dark:bg-gray-800">
            <TableHead className="border border-gray-300 text-center">Employee Details</TableHead>
        ...
        <TableBody>
          {employees?.map((employee, i) => (
            <TableRow key={employee.id} className="text-center text-base font-medium">
              ...
              <TableCell className="border border-gray-300 bg-blue-50">{employee.monthlyGross || "0.00"}</TableCell>
