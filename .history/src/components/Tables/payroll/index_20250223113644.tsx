            ...
            <Table className="min-w-full">
              <TableHeader>
                <TableRow className="bg-gray-50/50">
                  <TableHead colSpan={2} className="px-6 py-4 text-sm font-semibold text-gray-900">
                    <div className="flex items-center justify-center">Details</div>
                  </TableHead>

                  <TableHead colSpan={2} className="px-6 py-4 text-sm font-semibold text-blue-900 bg-blue-50/50">
                    <div className="flex items-center justify-center">
                      Total Earnings 
                      <Plus className="ml-2 cursor-pointer text-blue-500 hover:text-blue-600 transition-colors" size={16} />
                    </div>
                  </TableHead>

                  <TableHead className="px-6 py-4 text-sm font-semibold text-green-900 bg-green-50/50">
                    <div className="flex items-center justify-center">
                      Total Additions 
                      <Plus className="ml-2 cursor-pointer text-green-500 hover:text-green-600 transition-colors" size={16} />
                    </div>
                  </TableHead>

                  <TableHead className="px-6 py-4 text-sm font-semibold text-red-900 bg-red-50/50" colSpan={2}>
                    <div className="flex items-center justify-center w-full">
                      Toal Deductions 
                      <Minus className="ml-2 cursor-pointer text-red-500 hover:text-red-600 transition-colors" size={16} />
                    </div>
                  </TableHead>

                  <TableHead className="px-6 py-4 text-sm font-semibold text-blue-900 bg-blue-50/50" rowSpan={2}>
                    <div className="flex items-center justify-center" >
                      Total Net Salaries
                    </div>
                  </TableHead>
                ...
                <TableRow className="bg-gray-50/30">
                  <TableHead className="px-6 py-4 text-sm font-semibold text-gray-900">
                    <div className="flex items-center justify-center">Employee Details</div>
                  </TableHead>

                  <TableHead className="px-6 py-4 text-sm font-semibold text-blue-900 bg-blue-50/50">
                    <div className="flex items-center justify-center">Earnings</div>
                  </TableHead>

                  <TableHead className="px-6 py-4 text-sm font-semibold text-green-900 bg-green-50/50">
                    <div className="flex items-center justify-center">Additions</div>
                  </TableHead>
              ...
              <TableBody>
                <TableRow className="bg-gray-50/30">
                  <TableCell colSpan={2} className="px-6 py-4 text-lg font-bold text-gray-900">
                    Total
                  </TableCell>
                  <TableCell className="px-6 py-4 text-lg font-bold text-blue-900">
                    {new Intl.NumberFormat('en-US', { style: 'currency', currency: payroll?.currency }).format(
                      payroll?.totalMonthlyGross || 0
                    )}
                  </TableCell>
                  <TableCell className="px-6 py-4 text-lg font-bold text-green-900">
                  ...
                  <TableCell className="px-6 py-4 text-lg font-bold text-red-900" colSpan={2}>
                    <ul className="divide-y divide-gray-300 rounded-lg">
                ...
                {payroll?.processedEmployees.map((employee, index) => (
                  ...
                  >
                    <TableCell className="px-6 py-4 text-sm text-gray-600 border-b border-gray-100">
                      {index + 1}
                    </TableCell>
                    <TableCell className="px-6 py-4 text-sm font-medium text-gray-900 border-b border-gray-100">
