      ...
      <Table className="min-w-full border-collapse border border-gray-200">
        <TableHeader>
          ...
          <TableHead colSpan={2} className="border border-gray-300 text-center">
            ...
            <TableHead className="border border-black-300 text-center bg-blue-100" >
          ...
          <TableRow className="uppercase bg-gray-200">
            ...
            <TableHead className="border border-black-300 text-center bg-blue-100">salary</TableHead>
          </TableRow>
        </TableHeader>
