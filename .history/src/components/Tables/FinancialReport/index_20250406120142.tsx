...
import { User2, Building2, Briefcase, Calendar,  ChevronRight, Phone} from "lucide-react";
import Link from "next/link";
import { PayrollWithEmployeeAndCustomTaxes } from "@/types/payroll";
import { getPayrollTransactions } from "@/actions/reportActions";

export default async function FinancialReportTable({ query, currentPage }: { query: string, currentPage: number }) {
            ...
            {payrolls?.map((payroll, i) => (
              ...
              >
                ...
                <TableCell className="text-gray-700">
                  {payroll.paymentDate?.toLocaleString()}
                </TableCell>
                ...
                <TableCell className="text-gray-700">
                   {payroll.totalNetAmount}
                </TableCell>
                <TableCell className="font-medium text-gray-900">
                  {payroll.totalTaxesAmount}
                </TableCell>
                <TableCell className="text-gray-700">
                  {payroll.totalDeductionAmount}
                </TableCell>
