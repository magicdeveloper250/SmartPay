...
import { User2, Building2, Briefcase, Calendar, Banknote, ChevronRight, Phone, Mail, EllipsisVertical } from "lucide-react";
                ...
                <PopoverWrapper
                      ...
                      content={
                        <div className="flex flex-col space-y-1">
                          <Link href={`/employee/internal/${employee?.id}`} scroll={false} className="
