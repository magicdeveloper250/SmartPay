      ...
      <Table>
        ...
        <TableBody>
          {employees?.map((employee, i) => (
           <Link
            href={`/employee/internal/${employee.id}`}
           key={employee.firstName + i}
           className="block"
         >
           <TableRow className="text-center text-base font-medium text-dark dark:text-white hover:bg-gray-100 dark:hover:bg-gray-800 cursor-pointer">
             <TableCell>
               <div>{i + 1}</div>
             </TableCell>
