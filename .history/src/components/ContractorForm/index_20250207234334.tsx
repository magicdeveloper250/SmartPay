...
const employeeSchema = z.object({
  ...
  paymentPhone: z.string().regex(/^\+?[1-9]\d{1,14}$/, "Invalid payment phone number"),
  ...
  message: "Bank details are required when Bank is selected.",
  path: ["bankName", "bankAccountNumber", "swiftCode"],
});
