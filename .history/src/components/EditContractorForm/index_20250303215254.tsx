...
useEffect(()=>{
  setValue("id", contractor?.firstName || "" ),
  ...
  setValue("contractorID", contractor?.nationalID || "")
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4">
            ...
            <div>
              ...
              <input 
                ...
                aria-describedby={errors.contractorID ? "employeeID-error" : undefined}
                className="w-full p-3 border rounded-lg focus:ring-2 focus:ring-primary focus:border-primary outline-none"
                placeholder="Enter employee ID"
                disabled
              />
              {errors.contractorID && (
                <p id="employeeID-error" className="text-red-500 text-sm mt-1" role="alert">{errors.contractorID.message}</p>
              )}
            </div>
