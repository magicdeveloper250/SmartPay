        ...
        <div className="-mx-4 mt-[60px] flex flex-wrap lg:mt-20">
          <div className="w-full px-4 lg:w-1/2">
            ...
            <SingleFaq
              ...
              answer="Our Payroll Management System streamlines payroll processes for companies, ensuring accurate payments to employees and gig workers while adhering to compliance requirements."
            />
            <SingleFaq
              question="What are Embedded Financial Services?"
              answer="Embedded Financial Services offer gig workers and employees access to tailored financial products like loans, savings, and payments, directly integrated into their workflow."
            />
          </div>
