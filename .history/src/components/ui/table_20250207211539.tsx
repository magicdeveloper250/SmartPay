...
export function Table({
  ...
  return (
    <div className="relative w-full overflow-x-auto">
      <table
        className={cn("w-full min-w-max caption-bottom text-sm md:text-base", className)}
        {...props}
      />
    </div>
  );
...
export function TableHead({
  ...
  return (
    <th
      className={cn(
        "h-12 px-2 md:px-4 text-left align-middle font-medium text-neutral-500 dark:text-neutral-400 [&:has([role=checkbox])]:pr-0",
        className,
      )}
      {...props}
    />
