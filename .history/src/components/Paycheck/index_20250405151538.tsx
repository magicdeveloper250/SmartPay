...
const PayStub: React.FC<PaycheckProps> = ({ 
  ...
  return (
    ...
    <div className='px-4'>{/* Earnings Section - Fixed structure and mapping */}
    <div className="py-4 border-b border-gray-300">
      ...
      <div className="grid grid-cols-4 gap-2 py-1">
        ...
        <div className="text-right">{paycheckData.mainPayroll?.paymentDate?.toISOString()}</div>
      </div>
    ...
    {/* Deductions Section - Fixed structure and mapping */}
    <div className="py-4 border-b border-gray-300">
      <div className="grid grid-cols-4 gap-2 border-b border-gray-300 pb-2">
      ...
      <div className="grid grid-cols-4 gap-2 py-2 mt-2 border-t border-gray-300">
        ...
        <div className="text-center font-bold">
          ${((totalTaxes || 0) + 
             (paycheckData.taxes ? paycheckData.taxes.reduce((sum, tax) => sum + tax.taxAmount, 0) : 0) + 
             (paycheckData.deductions ? paycheckData.deductions.reduce((sum, ded) => sum + ded.amount, 0) : 0) + 
             (totalDeductions || 0)).toFixed(2)}
        </div>
        <div></div>
      </div>
    </div>
    
    {/* Summary Section - Fixed structure and calculations */}
    ...
    {/* Totals Footer - Simplified and cleaned up */}
