...
const PayStub: React.FC<PaycheckProps> = ({ 
  paycheckData, 
  companyName = "SMITH AND COMPANY, INC.",
  companyAddress = "123 Main Street, Maintown, CA 12345"
}) => {
...
const PaycheckComponent: React.FC = () => {
  ...
  return (
    ...
    //     <h1 className="text-2xl font-bold mb-8 text-center">Employee Pay Stub</h1>
