...
import { PayrollReturnType, payrollWithContractor, payrollWithEmployee } from '@/types/payroll';

export function PayrollDetail ({ mainPayroll, payrolls }: { mainPayroll: MainPayroll, payrolls: payrollWithContractor[] }){
  ...
  const filteredPayrolls = payrolls.filter(payroll => {
    ...
    const matchesSearch = (payroll?.contractor?.firstName?.toLowerCase() || '')
      .includes(searchTerm.toLowerCase()) ||
      (payroll?.contractor?.secondName?.toLowerCase() || '')
      .includes(searchTerm.toLowerCase());
