      ...
      <div>
        ...
        <div className="border rounded-lg overflow-hidden">
          <div className="grid grid-cols-4 bg-gray-50 p-4 border-b">
            ...
            <div className="font-medium text-gray-600">RRA Taxes</div>
            <div className="font-medium text-gray-600">RSSB Contributions</div>
              ...
              >
                ...
                <div>
                  <ul className="divide-y divide-gray-200 rounded-lg">
                    {payroll.additionalIncomes.map((income, index) => (
                  ...
                  <ul className="divide-y divide-gray-200 rounded-lg">
                    {payroll.taxes.map((tax, index) => (
                      <li key={index} className="grid grid-cols-1 text-sm">
                        ...
                        <span className="p-2 text-right font-medium">
                          {new Intl.NumberFormat('en-US', { style: 'currency', currency: "USD" }).format(tax?.tax?.name == SupportedTaxes.PIT ?calculateRwandaIncomeTax({
                              taxYear: getCurrentSupportedTaxYear(),
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Link href={`/employee/internal/${payroll?.employee?.id}`} scroll={false}><ChevronRight className="w-5 h-5 text-gray-400" /></Link>
                </div>
              </div>
            ))}
          </div>
