      ...
      case PaymentStatus.Pending:
        return (
          ...
          <button
            ...
            disabled={isLoading}
            className="px-4 py-2 text-sm font-medium text-black bg-red-600 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isLoading ? (
              <Loader2 className="w-4 h-4 animate-spin" />
            ) : (
