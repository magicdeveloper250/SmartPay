...
import { ChevronRight, Loader2, Search, Ban, CheckCircle2, PlayCircle, X, Info } from 'lucide-react';
                  ...
                  {payroll.taxes.map((tax, idx) => (
                    ...
                    >
                      <div className="flex items-center gap-2 flex-col">
                        <span className="font-extrabold flex justify-between">
                          {tax.taxName}   <Info className="w-4 h-4 text-gray-400 hover:text-gray-600" />
                        </span>
                        ...
                        {new Intl.NumberFormat('en-US', { 
                          ...
                          currency: "RWF" 
                            ...
                            <Popover.Panel   anchor="top" className="absolute z-10  mt-1 bg-white shadow-lg rounded-md border border-gray-200 p-4 ">
                              <h4 className="font-bold mb-2">{tax.taxName}</h4>
                              <div 
                                className="prose prose-sm max-w-none w-fit" 
