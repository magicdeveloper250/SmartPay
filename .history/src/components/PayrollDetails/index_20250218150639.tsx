...
export function PayrollDetail ({ mainPayroll, payrolls }: { mainPayroll: MainPayroll, payrolls: Payroll[] }){
  ...
  const handleCancelPayroll = async () => {
    ...
    try {
      // Replace with your actual cancel action
      // await cancelPayroll(mainPayroll.id);
  ...
  const handleActivatePayroll = async () => {
    setIsMainActionLoading(true);
    try {
      // Replace with your actual activate action
  ...
  const handlePayAll = async () => {
    setIsMainActionLoading(true);
    try {
      // Replace with your actual pay all action
      // await payAllPayroll(mainPayroll.id);
