...
import { PayrollReturnType, payrollWithEmployee, PayrollWithPerson } from '@/types/payroll';
...
export function PayrollDetail({ 
  ...
  mainPayroll: MainPayroll, 
  payrolls: PayrollWithPerson[],
  ...
  const filteredPayrolls = payrolls.filter(payroll => {
    ...
    const matchesSearch = (person?.firstName?.toLowerCase() || '')
      .includes(searchTerm.toLowerCase()) ||
      (person?.secondName?.toLowerCase() || '')
      .includes(searchTerm.toLowerCase());
