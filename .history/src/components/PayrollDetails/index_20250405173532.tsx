...
export function PayrollDetail({ mainPayroll, payrolls }: { mainPayroll: MainPayroll, payrolls: PayrollWithEmployeeAndCustomTaxes[]}) {
  ...
  <li key={idx} className="grid grid-cols-1 text-sm relative isolate">
    <Popover className="relative">
      {({ open }) => (
        <>
          ...
          <PopoverPanel className="absolute z-50 w-72 bg-white shadow-lg rounded-md p-4 border bottom-full mb-2 left-0">
