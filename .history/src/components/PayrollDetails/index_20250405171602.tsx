...
import { Dialog, DialogBackdrop, DialogPanel, PopoverButton, Popover, PopoverPanel } from '@headlessui/react';
...
export function PayrollDetail({ mainPayroll, payrolls }: { mainPayroll: MainPayroll, payrolls: PayrollWithEmployeeAndCustomTaxes[]}) {
  ...
  <li key={idx} className="grid grid-cols-1 text-sm relative">
    <Popover className="relative">
      {({ open }) => (
        <>
          ...
          <PopoverPanel className="absolute z-10 w-72 bg-white shadow-lg rounded-md p-4 border mt-2">
