...
export function PayrollDetail ({ mainPayroll, payrolls }: { mainPayroll: MainPayroll, payrolls: payrollWithEmployee[] }){
  ...
  const isContractor = mainPayroll.type === PayrollType.CONTRACTOR;
          ...
          {filteredPayrolls.map(payroll => (
            ...
            >
              <div>
                ...
                {isContractor && payroll?.employee?.companyName && (
                  <p className="text-sm text-gray-500">{payroll.employee.companyName}</p>
                )}
              </div>
              <div>
