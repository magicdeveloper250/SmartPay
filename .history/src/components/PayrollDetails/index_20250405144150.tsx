...
export function PayrollDetail({ mainPayroll, payrolls }: { mainPayroll: MainPayroll, payrolls: PayrollWithEmployeeAndCustomTaxes[]}) {
    ...
    switch (status) {
      ...
      case PaymentStatus.Paid:
        return (
          ...
          <button
            onClick={()=>setCurrentPayroll(payrollId)}
  ...
  return (
   ...
   <PaycheckComponent open={viewPayCheck} paycheckData={{data: payrolls.filter(p=>p.id==currentPayroll)[0]}} onClose={()=>setViewPaycheck(false)}/>
