...
import PaycheckComponent, { PaycheckData } from '../Paycheck';
const paycheckcData: PaycheckData = {
  id: "67f0e2f74d48a538705f334a",
  employeeId: "67f0e1fc4d48a538705f3347",
  employee: {
    id: "67f0e1fc4d48a538705f3347",
    firstName: "John",
    secondName: "Doe",
  ...
  createdAt: new Date(),
  updatedAt: new Date(),
  mainPayollId: "67f0e2f74d48a538705f3349",
  contractId: null,
  contractorId: null,
  companyName:"ImpanoSoftwares",
  companyAddress:"Kamembe"
...
export function PayrollDetail({ mainPayroll, payrolls }: { mainPayroll: MainPayroll, payrolls: PayrollWithEmployeeAndCustomTaxes[]}) {
  ...
  return (
    ...
    >
      ...
      { hoveredTaxIndex === index &&  <div dangerouslySetInnerHTML={{__html:tax.taxDescription}}/>}
    </li>
  );
})}
                  </ul>
   ...
   <PaycheckComponent open={viewPayCheck} paycheckData={paycheckcData} onClose={()=>setViewPaycheck(false)}/>
