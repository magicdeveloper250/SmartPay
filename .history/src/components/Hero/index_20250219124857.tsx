                ...
                <div>
                  ...
                  >
                    <a
                      ...
                      target="_blank"
                    >
                       <Image  src="/images/brands/airtel.svg" alt="airtel logo" width={64} height={64} />
                    </a>
                    <a
                      href="#"
                      className="text-white/60 duration-300 ease-in-out hover:text-white"
                      target="_blank"
                    >
                       <Image  src="/images/brands/mtn.svg" alt="mtn logo" width={64} height={64} />
                    </a>
                    <a
                      href="#"
                      className="text-white/60 duration-300 ease-in-out hover:text-white"
                      target="_blank"
                    >
                       <Image  src="/images/brands/safaricom.svg" alt="safaricom logo" width={64} height={64} />
                    </a>
                    <a
                      href="#"
                      className="text-white/60 duration-300 ease-in-out hover:text-white"
