                ...
                <div>
                  ...
                  >
                    <a
                      ...
                      target="_blank"
                    >
                       <img src="/images/brands/airtel.svg" alt="airtel logo" width="64px" height="64px" />
                    </a>
                    <a
                      href="#"
                      className="text-white/60 duration-300 ease-in-out hover:text-white"
                      target="_blank"
                    >
                       <img src="/images/brands/mtn.svg" alt="mtn logo" width="64px" height="64px" />
                    </a>
                    <a
                      href="#"
                      className="text-white/60 duration-300 ease-in-out hover:text-white"
                      target="_blank"
                    >
                       <img src="/images/brands/safaricom.svg" alt="safaricom logo" width="64px" height="64px" />
                    </a>
                    <a
                      href="#"
                      className="text-white/60 duration-300 ease-in-out hover:text-white"
                      target="_blank"
                    >
                       <img src="/images/brands/vodacom.svg" alt="vodacom logo" width="100px" height="64px" />
                    </a>
