...
import { Contractor,ContractorBenefit, AppliedTax, PredefinedTax } from '@prisma/client';
import toast from 'react-hot-toast';
import { addEmployeeBenefit, addEmployeeTax, deleteEmployeeBenefit, deleteEmployeeTax } from '@/actions/employeeActions';
 
import Link from 'next/link';

export default function ContractorDisplay({ contractor, benefits, taxes }: { contractor: Contractor, benefits: ContractorBenefit[], taxes: AppliedTax[] }) {
