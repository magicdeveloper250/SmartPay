...
import { payrollWithEmployee, PayrollWithEmployeeAndCustomTaxes } from '@/types/payroll';
...
interface PaycheckComponentProps {
  ...
  paycheckData: payrollWithEmployees;
      ...
      <div className="bg-primary text-white p-6">
        <div className="grid grid-cols-2">
          ...
          <div className="text-right">
            ...
            <p className="text-md">Payment Date: {paycheckData.mainPayroll?.paymentDate?.toDateString()}</p>
          </div>
        </div>
      </div>
