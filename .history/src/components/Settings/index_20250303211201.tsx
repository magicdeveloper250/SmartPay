...
import { updateCompanyPrrofileSettings, updateGeneralSettings, updatePayrollSettings, updatePredefinedTaxes } from '@/actions/settingsActions' 
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="mb-6">
      <fieldset className="border rounded-lg p-6 bg-gray-50">
        <legend className="text-xl font-semibold px-2 bg-gray-50 text-blue-700">
          Tax Settings
        </legend>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4">
            ...
            <div>
              ...
              {errors.company?.email && (
                <p id="company-email-error" className="text-red-500 text-sm mt-1" role="alert">
            ...
            <div>
              <label htmlFor="company.pensionCode" className="block text-sm font-medium mb-1 text-gray-700">
                Pension Code <span className="text-red-500">*</span>
              </label>
              <input 
              ...
              {errors.company?.pensionCode && (
                <p id="pension-code-error" className="text-red-500 text-sm mt-1" role="alert">
        ...
        <div className="space-y-6">
          <div>
            ...
            {errors.generalSettings?.defaultCurrency && (
              <p id="currency-error" className="text-red-500 text-sm mt-1" role="alert">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-x-8 gap-y-4">
            <div>
              <label htmlFor="payrollStartDate" className="block text-sm font-medium mb-1 text-gray-700">
                Payroll Start Date <span className="text-red-500">*</span>
              </label>
              <input 
                id="payrollStartDate"
                type="number"
            ...
            <div>
              <label htmlFor="payrollEndDate" className="block text-sm font-medium mb-1 text-gray-700">
                Payroll End Date <span className="text-red-500">*</span>
              </label>
              <input 
                id="payrollEndDate"
                type="number"
              ...
              {errors.generalSettings?.payrollEndDate && (
                <p id="end-date-error" className="text-red-500 text-sm mt-1" role="alert">
            ...
            <div>
              ...
              {errors.generalSettings?.paymentDay && (
                <p id="payment-day-error" className="text-red-500 text-sm mt-1" role="alert">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-x-8 gap-y-4">
            <div>
              ...
              {errors.payrollSettings?.overtimeRate && (
                <p id="overtime-rate-error" className="text-red-500 text-sm mt-1" role="alert">
            ...
            <div>
              ...
              {errors.payrollSettings?.weekendRate && (
                <p id="weekend-rate-error" className="text-red-500 text-sm mt-1" role="alert">
            ...
            <div>
              <label htmlFor="payrollSettings.holidayRate" className="block text-sm font-medium mb-1 text-gray-700">
                Holiday Rate <span className="text-red-500">*</span>
              </label>
              <input 
              ...
              {errors.payrollSettings?.holidayRate && (
                <p id="holiday-rate-error" className="text-red-500 text-sm mt-1" role="alert">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4">
            <div>
              <label htmlFor="payrollSettings.maxOvertimeHours" className="block text-sm font-medium mb-1 text-gray-700">
                Maximum Overtime Hours <span className="text-red-500">*</span>
              </label>
              <input 
              ...
              {errors.payrollSettings?.maxOvertimeHours && (
                <p id="max-overtime-error" className="text-red-500 text-sm mt-1" role="alert">
            ...
            <div>
              <label htmlFor="payrollSettings.minWorkingHours" className="block text-sm font-medium mb-1 text-gray-700">
                Minimum Working Hours <span className="text-red-500">*</span>
              </label>
              <input 
              ...
              {errors.payrollSettings?.minWorkingHours && (
                <p id="min-working-error" className="text-red-500 text-sm mt-1" role="alert">
...
export default function SettingsForm({initialData}:{initialData:SettingsFormValues}) {
  ...
  return (
    <div className="w-full mx-auto rounded-lg p-6 bg-white shadow-md">
      ...
      />
      <TaxesForm
        initialData={initialData.taxes.map(tax => ({ tax }))}/>
