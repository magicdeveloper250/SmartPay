...
export function A4Modal({ 
  ...
  return (
    ...
    >
      ...
      <div className="fixed inset-0 flex w-screen items-center justify-center p-4 h-screen overflow-y-auto">
        <Dialog.Panel 
          className="w-[695px] transform bg-white shadow-2xl transition-all rounded-lg"
        >
          {/* Header */}
          <div className="flex items-center justify-between p-4 border-b">
          ...
          {/* Content Container - A4 Paper Size */}
          <div className="p-6 flex justify-center">
            <div className="w-[595px] min-h-[842px] bg-white shadow-lg">
              {children}
            </div>
          </div>
        </Dialog.Panel>
...
export function A4DetailsModal({
  children,
  title,
  showCloseButton = true,
  backButtonDisabled = true,
  ...
  return (
    <Dialog open={true} onClose={() => {}} className="relative z-50">
      <Dialog.Backdrop className="fixed inset-0 bg-black/50 backdrop-blur-none" />

      <div className="fixed inset-0 flex w-screen justify-end h-screen overflow-y-auto">
        <Dialog.Panel
          className="w-[695px] transform bg-white shadow-2xl transition-all h-fit"
        >
          <div className="flex items-center justify-between p-4 border-b">
            <div className="flex items-center space-x-4">
              {onBack && (
