...
export function FitModal({
  ...
  return (
    <Dialog open={true} onClose={() => {}} className="relative z-50">
      ...
      <div className="fixed inset-0 flex items-center justify-center p-4 h-screen overflow-y-auto">
        <DialogPanel
          className={`transform rounded-xl bg-white shadow-2xl transition-all max-w-md`}
        >
          <div className="flex items-center justify-between p-4 border-b">
            {onBack && (
              <div className="mb-6">
