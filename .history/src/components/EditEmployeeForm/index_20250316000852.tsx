...
useEffect(()=>{
  ...
  setValue("startDate", employee?.startDate || new Date())
  setValue("gender", employee?.gender || Gender.Female)
  setValue("paymentFrequency", employee?.paymentFrequency || PaymentFrequency.MONTHLY)
  setValue("dob", employee?.dob || new Date())
