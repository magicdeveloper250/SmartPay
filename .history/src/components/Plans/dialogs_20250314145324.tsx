...
// export const OfferFormDialog: React.FC<PlanFormDialogProps> = ({ 
//   open,
//   onCancel 
// }) => {
//   const [isSubmitting, startTransition] = useTransition();
...
//           .map(({ id, name, companyTierId, isActive, createdAt,isRecommended, price, updatedAt}) => ({ 
//             id, name, companyTierId, isActive, createdAt,isRecommended, price, updatedAt
//           }));
