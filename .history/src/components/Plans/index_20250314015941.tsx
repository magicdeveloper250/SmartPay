          ...
          <div>
            ...
            <div className="mt-1 space-y-2">
              {fields.map((feature, index) =>{
                ...
                return (
                 <div  key={feature.id} className="p-4 border rounded-md bg-white">
                ...
                <div>
                  <label htmlFor={`features.${index}.features.name`} className="block text-sm font-medium mb-1 text-gray-700">
                    Feature Name <span className="text-red-800">*</span>
                  </label>
                  <input 
                    id={`features.${index}.feature.name`}
                ...
                <div>
                  <label htmlFor={`features.features.${index}.description`} className="block text-sm font-medium mb-1 text-gray-700">
                    Description <span className="text-red-800">*</span>
                  </label>
                  <textarea 
                    id={`features.features${index}.description`}
