...
import { PlanFormDialog, CompanyTierDialog, FeatureDialog } from './dialogs';
                    ...
                    <table className="min-w-full divide-y divide-gray-200">
                      ...
                      <tbody className="bg-white divide-y divide-gray-200">
                        {filteredOffers.map((offer) => (
                          <tr key={offer.id}>
                            <td className="px-6 py-4 whitespace-nowrap font-medium text-gray-900">{offer.name}</td>
                            <td className="px-6 py-4 whitespace-nowrap font-medium text-gray-900">{offer.description}</td>
                            <td className="px-6 py-4 whitespace-nowrap font-medium text-gray-900">{offer.discountAmount?.toFixed(2)}</td>
                            <td className="px-6 py-4 whitespace-nowrap font-medium text-gray-900">{offer.discountPercentage?.toFixed(2)}</td>
                            <td className="px-6 py-4 whitespace-nowrap font-medium text-gray-900">{offer.startDate.toLocaleString()}</td>
                            <td className="px-6 py-4 whitespace-nowrap font-medium text-gray-900">{offer?.endDate?.toLocaleString()}</td>
