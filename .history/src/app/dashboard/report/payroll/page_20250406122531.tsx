...
import FinancialReportTable from "@/components/Tables/FinancialReport";
...
const FinancialReportPage = async (props: {
      ...
      <div className={cn(
        ...
        <div className="border-b border-gray-100 dark:border-gray-800 p-4">
          <div className="flex items-center gap-4">
            <div className="flex-1">
              <Search 
                placeholder="Search payroll transactions" 
        ...
        <div className="overflow-x-auto px-4">
          <Suspense fallback={<EmployeesSkeleton />}>
            <FinancialReportTable query={query} currentPage={currentPage} />
          </Suspense>
        </div>
      </div>
    </div >
