...
const  ContractorPage =async(props: {
  ...
  return (
    ...
    <Link href={"/contractor"} scroll={false} className={`px-4 py-2 rounded-md transition "bg-transparent text-gray-700 hover:bg-gray-300 dark:text-gray-300 dark:hover:bg-gray-600` }>File</Link>
    <Link href={"/contractor"} scroll={false} className={`px-4 py-2 rounded-md transition "bg-transparent text-gray-700 hover:bg-gray-300 dark:text-gray-300 dark:hover:bg-gray-600` }>New</Link>
