        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
         ...
         <legend className="text-xl font-semibold mb-4 col-span-2">Personal Information</legend>
          ...
          <div className="flex gap-6">
            <button 
              type="submit"
               className="flex-1 p-2 rounded-lg flex w-full cursor-pointer items-center justify-center rounded-md border border-primary bg-primary px-5 py-3 text-base text-white transition duration-300 ease-in-out hover:bg-blue-dark"
            >
