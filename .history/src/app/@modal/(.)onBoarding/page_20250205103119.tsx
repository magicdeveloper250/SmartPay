        ...
        <form onSubmit={handleSubmit} className="space-y-4">
         <fieldset>
          ...
          <button 
            ...
            className={`h-10 border-2 border-gray-200 rounded-lg hover:border-blue-500 hover:bg-blue-50 transition-colors` + banckType=="bank"&&"border-blue-500"}
            type="button"
          >
             bank
          </button>
          <button 
            ...
            className={`h-10 border-2 border-gray-200 rounded-lg hover:border-blue-500 hover:bg-blue-50 transition-colors`+ + banckType=="crypto"&&"border-blue-500"}
            type="button"
          >
             crypto Wallet
          </button>
