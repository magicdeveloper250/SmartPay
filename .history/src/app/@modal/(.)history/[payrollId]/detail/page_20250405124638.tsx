...
import { payrollWithContractor, payrollWithEmployee, PayrollWithEmployeeAndCustomTaxes } from "@/types/payroll";
...
export default async function Page({ params, searchParams }: PageProps) {
  ...
  const payrollType = resolvedSearchParams.type || PayrollType.EMPLOYEE;
    ...
    >
       <Suspense fallback={<EmployeeDetailsSkeleton/>}>
        {payrollType === PayrollType.EMPLOYEE && 
          <PayrollDetail 
            mainPayroll={payroll} 
            payrolls={payroll.payrolls as PayrollWithEmployeeAndCustomTaxes[]} 
          />
        }
