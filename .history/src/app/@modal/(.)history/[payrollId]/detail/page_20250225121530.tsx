...
type Props = Promise<{ payrollId: string;
  type?:PayrollType;searchParams?: Promise<{
    type?: string;
}>; }>

export default async function Page( props: { params: Props }) {
  const { payrollId, searchParams } = await props.params;
  console.log("PayrollType...........................................................................:", (await searchParams)?.type)
  const payrollType= (await searchParams)?.type|| PayrollType.EMPLOYEE
