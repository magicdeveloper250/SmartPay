...
export async function addEmployeeTax(employeeId: string, taxId:string) {
  ...
  try {
     const employee= await prisma.appliedTax.create({
    data:{
      employeeId:employeeId,
      taxId:taxId
...
export async function addEmployeeContribution(employeeId: string, contributionId:string) {

  try {
     const employee= await prisma.appliedContribution.create({
    data:{
      employeeId:employeeId,
...
export async function deleteEmployeeTax( taxId: string, employeeId: string,) {
  ...
  try {
    const employee=await prisma.appliedTax.delete({
    where:{
      id:taxId,
      employeeId:employeeId
    }
...
export async function deleteEmployeeContribution( contributionId: string, employeeId: string,) {

  try {
    const employee=await prisma.appliedContribution.delete({
    where:{
      id:contributionId,
      employeeId:employeeId
    }
...
export async function deleteEmployeeIncome( incomeId: string, employeeId: string,) {
  ...
  try {
    const employee=await prisma.additionalIncome.delete({
    where:{
      id:incomeId,
      employeeId:employeeId
    }
...
export async function changeEmployeeIncomeStatus( incomeId: string, employeeId: string, newStatus:PaymentStatus) {
  ...
  try {
    const employee =await prisma.additionalIncome.update({
      where:{
        id:incomeId,
        employeeId:employeeId
      },
...
export async function deleteEmployeeDeduction( deductionId: string, employeeId: string,) {
  ...
  try {
    const employee= await prisma.deduction.delete({
    where:{
      id:deductionId,
      employeeId:employeeId
    }
...
export async function changeEmployeeDeductionStatus( deductionId: string, employeeId: string, newStatus:PaymentStatus) {
  ...
  try {
    const employee=await prisma.deduction.update({
      where:{
        id:deductionId,
        employeeId:employeeId
      },
