...
data = {
    ...
    "bankName": [fake.random_element(elements=("Bank of America", "Chase", "Wells Fargo", "Citi")) for _ in range(num_employees)],
    "bankAccountNumber": [fake.unique.iban() for _ in range(num_employees)],
    "swiftCode": [fake.unique.swift11()  for _ in range(num_employees)],
