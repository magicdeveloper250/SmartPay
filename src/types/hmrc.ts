import type {  SupportedRwandaTaxYear,
  ...
  const rwandaTaxRates: Record<SupportedRwandaTaxYear, RwandaTaxRates> = {
    "2023": {
      COUNTRY: "Rwanda",
      // Income tax
      DEFAULT_PERSONAL_ALLOWANCE: 0, // Updated to reflect the new tax-free threshold
      LOWER_BRACKET: 60_000, // Updated to reflect the new lower bracket
      MIDDLE_BRACKET: 100_000, // Updated to reflect the new middle bracket
      UPPER_BRACKET: 200_000, // Updated to reflect the new upper bracket
